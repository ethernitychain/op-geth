...
func (b *testWorkerBackend) newRandomTx(creation bool) *types.Transaction {
	...
	if creation {
		...
		tx, _ = types.SignTx(types.NewTransaction(b.txPool.Nonce(testBankAddress), testUserAddress, big.NewInt(1000), testGas, gasPrice, nil), types.HomesteadSigner{}, testBankKey)
	}
	return tx
}
